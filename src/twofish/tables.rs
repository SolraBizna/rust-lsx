//! This module (and file) are a line-by-line translation of the equivalent
//! file from the C implementation. Comments from that file are reproduced
//! verbatim, including comments that originate from the GPG implementation
//! that informed mine; all comments not marked `-SB` originate from GPG.
...
pub const RS_POLY_TO_EXP: [u8; 255] = [
...
pub const RS_POLY_FROM_EXP: [u8; 492] = [
